                    ...
                    <tr>
                        <td class="font-bold px-3">
                            @if (null !== "old('contract_id')")
                                <input id="contract_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-center" type="text" name="contract_id" :value="" autofocus />
                            @else
                                <input id="contract_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-center" type="text" name="contract_id" :value="old('contract_id')" autofocus />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('area_id')")
                                <input id="area_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-center" type="text" name="area_id" :value="" />
                            @else
                                <input id="area_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-center" type="text" name="area_id" :value="old('area_id')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                        ...
                        <td class="font-bold px-3">
                            @if (null !== "old('suppliers_id')")
                                <input id="suppliers_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-center" type="text" name="suppliers_id" :value="" />
                            @else
                                <input id="suppliers_id" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full text-center" type="text" name="suppliers_id" :value="old('suppliers_id')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('var_fix')")
                        ...
                        <td class="font-bold px-3">
                            @if (null !== "old('subscription')")
                                <input id="subscription" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="subscription" :value="" />
                            @else
                                <input id="subscription" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="subscription" :value="old('subscription')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('mono')")
                                <input id="mono" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="mono" :value="" />
                            @else
                                <input id="mono" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="mono" :value="old('mono')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('bi_day')")
                                <input id="bi_day" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="bi_day" :value="" />
                            @else
                                <input id="bi_day" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="bi_day" :value="old('bi_day')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('bi_night')")
                                <input id="bi_night" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="bi_night" :value="" />
                            @else
                                <input id="bi_night" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="bi_night" :value="old('bi_night')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('excl_night')")
                                <input id="excl_night" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="excl_night" :value="" />
                            @else
                                <input id="excl_night" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="excl_night" :value="old('excl_night')" />
                            @endif
                        </td>
                        <td class="font-bold px-3">
                            @if (null !== "old('g_and_c_energy')")
                                <input id="g_and_c_energy" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="g_and_c_energy" :value="" />
                            @else
                                <input id="g_and_c_energy" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="text" name="g_and_c_energy" :value="old('g_and_c_energy')" />
                            @endif
                        </td>
                        <td class="font-bold text-center px-3">
                            @if (null !== "old('date_price_val')")
                                <input id="date_price_val" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="date" name="date_price_val" :value="" />
                            @else
                                <input id="date_price_val" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full" type="date" name="date_price_val" :value="old('date_price_val')" />
                            @endif
                        </td>
                    </tr>
                    </table>
