...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{__("Modification de prix")}}</title>
    ...
    <body class="antialiased">
        ...
        <div class="flex items-center justify-center mb-36 mt-36">
            <div class="bg-sky-400 p-5 rounded-lg w-fit">
                <div class="pb-5 max-w-7xl mx-auto sm:px-6 lg:px-8 font-bold text-center underline"><h2>{{__("Données de la fiche de prix à modifier")}}</h2></div>
                @if ($pricetomod->deleted==1)
                    <div class="pb-5 max-w-7xl mx-auto sm:px-6 lg:px-8 text-center underline font-bold text-red-600 px-3"><p><span class="bg-white w-fit">{{__("Il vous est interdit d'apporter une modification à cette fiche de prix !")}}</span></p></div>
                @else
                    <form method="post" action="{{route('pricemod.update', $pricetomod->id)}}">
                        ...
                        <table class="m-auto mb-10">
                            <tr>
                                <th class="px-3 text-white" colspan=13>{{__("Fiche de prix à modifier")}}</th>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="px-3 text-white"><label for="contract_id">{{__("ID")}}</label></th>
                ...
                @endif
                <div class="pb-5 max-w-7xl mx-auto sm:px-6 lg:px-8 font-bold text-center underline"><h2>{{__("Liste des fiches de prix")}}</h2></div>
